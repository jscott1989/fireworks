...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    create: function create() {
	        var nameLabel = game.add.text(80, 80, "Fireworks", { font: "50px Arial", fill: "#ffffff" });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recording = __webpack_require__(7);
	...
	module.exports = {
	     ...
	     */
	    playOriginal: function playOriginal(key) {
	        if (_lodash2.default.has(sounds, key)) {
	    ...
	    promptForSound: function promptForSound(key) {
	        // Show an overlay to prompt for sound
	        _recording2.default.open(function (url) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    onStartRecordingPressed: function onStartRecordingPressed() {
	        var self = this;
	    ...
	    onStopRecordingPressed: function onStopRecordingPressed() {
	        mediaRecorder.stop();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _drawing = __webpack_require__(9);
	...
	module.exports = {
	    create: function create() {
	        ...
	        var level1 = game.add.tilemap('level1');
	        level1.addTilesetImage('level1-tiles', 'level1-tiles');

	        var far1Layer = level1.createLayer('far1');
	        far1Layer.resizeWorld();
	        far1Layer.scrollFactorX = 0.5;
	        far1Layer.scrollFactorY = 0.9;

	        var far2Layer = level1.createLayer('far2');
	        far2Layer.scrollFactorX = 0.5;
	        far2Layer.scrollFactorY = 0.9;

	        var near1Layer = level1.createLayer('near1');
	        var near2Layer = level1.createLayer('near2');
	        ...
	        var front = level1.createLayer('front');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var selectTool = function selectTool(colour) {};

	var selectColour = function selectColour(colour) {
	...
	module.exports = {
	    open: function open(width, height, c) {
	        // TODO: Allow outlines
	        callback = c;
	        if (container == null) {
	            ...
	            // Create colours
	            var colourContainer = container.querySelector(".colours");
	            _lodash2.default.each(["#FFF", "#000", "#F00", "#0F0", "#00F", "#FF0", "#0FF", "#F0F", "#012", "#234", "#456", "#678", "#89A", "#BCD", "#CDE", "#DEF", "#F12", "#F34"], function (colour) {
	                var elem = document.createElement("div", { "class": "colour", "data-colour": "blue", "style": "background: blue" });
